    ...
    return (
        <div className={`${workplaceStyles['wrapper']} ${workplace ? workplaceStyles['vis'] : ''} `}>
                                ...
                                <div id={"lab2-print"} className={workplaceStyles["report-right"]}>
                                    <div className={workplaceStyles["report-right-container"]}>
                                        <div className={workplaceStyles["report-header"]}>
                                            ...
                                            <div className={workplaceStyles["report-header-text"]}>Правильных ответов: {gasComplete.reduce((sum, current) => {
                                                if (current) {
                                                    return sum + 1
                                                } else {
                                                    return sum;
            ...
            <div className={basedStyles['footer']}>
                ...
                <div onClick={toReport} className={`${basedStyles['report']} ${(tractOneComplete && tractTwoComplete) ? basedStyles['vis'] : ''} `}><div>ОТЧЕТ</div><img className={basedStyles["report-icon"]} src="./img/menu/report.png" /></div>
